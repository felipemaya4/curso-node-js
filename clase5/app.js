...
import { moviesRouter } from './routes/movies.js' // gestor de la ruta /movies
...
app.use('/movies', moviesRouter) // maneja todas las consultas que se hagan a /movies y las redirige al modulo moviesRoutes para que sea gestionado
